...
from .models import *
from .recaptcha import ReCaptchaV3FieldWithBypass
...
class AccountRequestSerializer(ModelSerializer):
    recaptcha = ReCaptchaV3FieldWithBypass(action='submit', required_score=settings.DRF_RECAPTCHA_MINIMUM_SCORE)
